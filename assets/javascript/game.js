...
function wordw() {
    var randomWords = ["Spider-Man", "Black Widow", "Thanos", "Deadpool", "Captin America", "Juggernaut", "Iron Man", "Hulk", "Quicksilver", "Cable", "Wolverine", "Ant-Man", "Loki", "Thor", "Rogue", "Magneto", "Groot", "Jean Grey", "Black Panther", "Iron Fist", "War Machine", "Gambit", "Cyclops", "Mister Fantastic", "Storm", "Nick Fury", "Daredevil", "Jessica Jones", "Luke Cage", "Professor X", "Captain Marvel", "Kingpin", "Doctor Strange", "Wasp", "Red Skull", "Falcon", "Firestar", "Beast", "Ghost Rider", "Green Goblin", "Human Torch", "Iceman", "Invisible Woman", "Bullseye", "Jubilee", "Killmonger", "Logan", "Mystique", "Namor", "Nightcrawler", "Punisher", "Sandman", "Scarlet Witch", "Spider-Woman", "She-Hulk", "Silver Surfer", "The Hand", "Tony Stark", "Peter Parker", "The Watchers", "Venom", "X-Force", "X-Men"]
